...
private val meditationIconVector: ImageVector = habitIconVector("SelfImprovement") {
    moveTo(12.0f, 6.0f)
...
internal val HabitTrackerIcons.meditationIcon: ImageVector
    get() = meditationIconVector
